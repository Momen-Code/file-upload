...
let AuthController = class AuthController {
    ...
    async register(createUserDto) {
        return this.authService.register({ ...createUserDto, role: role_constant_1.Role.USER });
    }
    async login(req) {
...
__decorate([
    (0, decorators_1.Public)(),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)("local-user")),
    (0, swagger_1.ApiResponse)({
...
AuthController = __decorate([
    (0, swagger_1.ApiTags)(swagger_constant_1.swagger.USER_AUTH),
